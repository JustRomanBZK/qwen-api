...
echo "========================================="
echo "  Qwen 2.5 Summarization API — Auto Setup"
echo "========================================="
...
# --- 5. Build & Start ---
echo "[*] Building and starting Qwen API..."
echo "[*] First launch will download ~20GB model. This takes 10-30 min."
docker compose up -d --build

echo ""
echo "========================================="
echo "  Qwen API is starting!"
echo "  Model loading takes 2-5 minutes."
echo ""
